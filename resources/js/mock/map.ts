...
export const heatCalPersonInfo: Record<number, { name: string; risk: string }> = { 1: { name: 'Marko Horvat', risk: 'Critical' }, 7: { name: 'Omar Hassan', risk: 'High' }, 9: { name: 'Carlos Mendoza', risk: 'Critical' }, 12: { name: 'Ivan Babić', risk: 'High' } };
...
export const MOCK_PREDICTIONS: PredRiskEntry[] = [
...
export const MOCK_PATTERNS: PatternEntry[] = [
...
export const MOCK_ROUTES: Record<string, RoutePoint[]> = {
    '1': [
...
export const keyboardShortcuts = [
    ...
    { key: 'M', description: 'Toggle markers' },
...
export const MOCK_SATELLITES: SatelliteData[] = [
    ...
    { noradId: 46826, name: 'USA-310 (SBIRS GEO-5)', intlDesignator: '2021-035B', lat: 0.0, lng: -89.0, alt: 35786, velocity: 3.07, inclination: 0.1, period: 1436, category: 'military', country: 'US', launchDate: '2021-05-18', status: 'active', orbitType: 'GEO', rcs: 12.5 },
    { noradId: 40699, name: 'USA-264 (MUOS-4)', intlDesignator: '2015-044A', lat: 0.0, lng: 75.0, alt: 35786, velocity: 3.07, inclination: 4.5, period: 1436, category: 'military', country: 'US', launchDate: '2015-09-02', status: 'active', orbitType: 'GEO', rcs: 18.0 },
    { noradId: 51104, name: 'COSMOS 2558', intlDesignator: '2022-015A', lat: 55.4, lng: 32.8, alt: 435, velocity: 7.65, inclination: 97.3, period: 93, category: 'military', country: 'RU', launchDate: '2022-02-05', status: 'active', orbitType: 'SSO', rcs: 0.8 },
    { noradId: 52877, name: 'YAOGAN 35A', intlDesignator: '2022-066A', lat: -22.4, lng: 128.6, alt: 490, velocity: 7.62, inclination: 35.0, period: 94, category: 'military', country: 'CN', launchDate: '2022-06-23', status: 'active', orbitType: 'LEO', rcs: 3.2 },
    { noradId: 44048, name: 'GSAT-7A (RUKMINI)', intlDesignator: '2018-104A', lat: 0.0, lng: 55.5, alt: 35786, velocity: 3.07, inclination: 0.1, period: 1436, category: 'military', country: 'IN', launchDate: '2018-12-19', status: 'active', orbitType: 'GEO', rcs: 8.0 },
    { noradId: 55555, name: 'OFEK 16', intlDesignator: '2020-042A', lat: 32.1, lng: 34.8, alt: 600, velocity: 7.56, inclination: 142.0, period: 97, category: 'military', country: 'IL', launchDate: '2020-07-06', status: 'active', orbitType: 'LEO', rcs: 0.3 },
    { noradId: 43600, name: 'JAMES WEBB SPACE TELESCOPE', intlDesignator: '2021-130A', lat: 0.0, lng: -170.0, alt: 1500000, velocity: 0.3, inclination: 0.0, period: 525960, category: 'scientific', country: 'US', launchDate: '2021-12-25', status: 'active', orbitType: 'HEO' },
    { noradId: 44716, name: 'STARLINK-1010', intlDesignator: '2020-001D', lat: 42.5, lng: -32.2, alt: 550, velocity: 7.59, inclination: 53.0, period: 96, category: 'starlink', country: 'US', launchDate: '2020-01-07', status: 'active', orbitType: 'LEO' },
    { noradId: 44717, name: 'STARLINK-1011', intlDesignator: '2020-001E', lat: 44.1, lng: -28.9, alt: 550, velocity: 7.59, inclination: 53.0, period: 96, category: 'starlink', country: 'US', launchDate: '2020-01-07', status: 'active', orbitType: 'LEO' },
    { noradId: 44718, name: 'STARLINK-1012', intlDesignator: '2020-001F', lat: 39.8, lng: -36.5, alt: 550, velocity: 7.59, inclination: 53.0, period: 96, category: 'starlink', country: 'US', launchDate: '2020-01-07', status: 'active', orbitType: 'LEO' },
];
