...
const title = 'Admin Dashboard'; const icon = '📊'; const desc = 'System overview, KPIs, health indicators, quick actions.';
export default function AdminDashboard() {
    return (<><PageMeta title={title} /><div data-testid="admin-dashboard-page">
