...
const title = 'Audit Log'; const icon = '📋'; const desc = 'Immutable audit trail of all system actions and access events.';
export default function AdminAudit() {
    return (<><PageMeta title={title} /><div data-testid="admin-audit-page">
