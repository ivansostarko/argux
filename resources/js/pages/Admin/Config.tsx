...
const title = 'Configuration'; const icon = '⚙️'; const desc = 'System settings, notifications, map, security, retention, and AI.';
export default function AdminConfig() {
    return (<><PageMeta title={title} /><div data-testid="admin-config-page">
