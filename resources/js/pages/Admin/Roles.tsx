...
const title = 'Role Management'; const icon = '🔑'; const desc = 'Configure roles, permissions matrix, and access levels.';
export default function AdminRoles() {
    return (<><PageMeta title={title} /><div data-testid="admin-roles-page">
