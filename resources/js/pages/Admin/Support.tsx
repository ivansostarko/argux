...
const title = 'Support Tickets'; const icon = '🎫'; const desc = 'Manage support requests, bug reports, and feature requests.';
export default function AdminSupport() {
    return (<><PageMeta title={title} /><div data-testid="admin-support-page">
