...
const title = 'Knowledge Base'; const icon = '📚'; const desc = 'Help articles, documentation, and training materials.';
export default function AdminKnowledgeBase() {
    return (<><PageMeta title={title} /><div data-testid="admin-kb-page">
