                        ...
                        <Section title="AI Intelligence Summary">
                            <div style={{ background: `linear-gradient(135deg, ${theme.accentDim}, rgba(10,14,22,0.4))`, border: `1px solid ${theme.accent}20`, borderRadius: 10, padding: 18 }}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 10 }}>
                                    ...
                                    <span style={{ fontSize: 11, fontWeight: 600, color: theme.accent, letterSpacing: '0.06em' }}>GENERATED BY ARGUX AI — {new Date().toLocaleDateString()}</span>
                                </div>
                                <p style={{ fontSize: 13, color: theme.text, lineHeight: 1.7, margin: 0, whiteSpace: 'pre-line' as const }}>{generateSummary(p)}</p>
                            </div>
                        </Section>
