            ...
            <div className="pf-layout" style={{ display: 'flex', gap: 20, alignItems: 'flex-start' }}>
                ...
                <div style={{ flex: 1, minWidth: 0, animation: 'argux-fadeIn 0.2s ease-out' }}>
                    ...
                    {tab === 'employment' && <>
                        ...
                        {employment.map((emp, i) => (
                            <Card key={emp.id}>
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: 10 }}>
                                    ...
                                    <div><Label>Location</Label><input value={emp.location} onChange={e => { const n = [...employment]; n[i] = { ...n[i], location: e.target.value }; setEmployment(n); }} placeholder="City, Country" style={{ width: '100%', padding: '8px 12px', background: theme.bg, color: theme.text, border: `1px solid ${theme.border}`, borderRadius: 6, fontSize: 13, fontFamily: 'inherit', outline: 'none' }} /></div>
                                </div>
                        ...
                        <AddBtn onClick={() => setEmployment([...employment, { id: generateId(), title: '', company: '', startDate: '', endDate: '', location: '', notes: '' }])} label="Add Employment" />
                    </>}
