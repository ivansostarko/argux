...
export default function TwoFactor() {
    ...
    const tr = (key: string, params?: Record<string, string>) => t(`two_factor.${key}`, lang, params);
    ...
    const handleResend = () => {
        setResent(true);
        setCountdown(30);
        router.post('/2fa/resend', { method }, { preserveState: true });
            ...
            {method !== 'app' && (
                <div style={{ textAlign: 'center', marginTop: 16 }}>
                    <button onClick={handleResend} disabled={countdown > 0} style={{
                        ...
                        color: countdown > 0 ? theme.textDim : theme.accent,
...
TwoFactor.layout = (page: React.ReactNode) => <AuthLayout>{page}</AuthLayout>;
